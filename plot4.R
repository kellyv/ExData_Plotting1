plot3 <- function() {
  ...
  par(mfcol=(c(2,2)))
  plot(subdata$datetimed, subdata$Global_active_power, type="n", ylab="Global Active Power", xlab="")
  ...
  legend("topright", legend=c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"), lwd=1, col=c(1,2,4), box.lwd=0)
  plot(subdata$datetime, subdata$Voltage, type="n", ylab="Voltage", xlab="datetime")
  lines(subdata$datetimed, subdata$Voltage, col=1)
  plot(subdata$datetime, subdata$Global_reactive_power, type="n", ylab="Global_reactive_power", xlab="datetime")
  lines(subdata$datetimed, subdata$Global_reactive_power, col=1)
  dev.off()
}